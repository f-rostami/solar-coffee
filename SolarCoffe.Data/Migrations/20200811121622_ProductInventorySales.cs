    ...
    public partial class ProductInventorySales : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalseOrderItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SalseOrderItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalseOrderItems_SalesOrders_SalesOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalseOrderItems_ProductId",
                table: "SalseOrderItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SalseOrderItems_SalesOrderId",
                table: "SalseOrderItems",
                column: "SalesOrderId");
        }
